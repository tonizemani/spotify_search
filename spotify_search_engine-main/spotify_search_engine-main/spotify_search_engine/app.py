...
def main():
    ...
    footer_container.image("spotify_search/spotify_search_engine-main/spotify_search_engine-main/spotify_search_engine/images
/download (2).jpg", use_column_width=True)
