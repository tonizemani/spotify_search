...
def main():
    ...
    im = Image.open('spotify_search/spotify_search_engine-main/spotify_search_engine-main/spotify_search_engine/images/download (1).jpg')
    ...
    file1_path = "spotify_search/spotify_search_engine-main/spotify_search_engine-main/spotify_search_engine/data/half1.csv"
    file2_path = "spotify_search/spotify_search_engine-main/spotify_search_engine-main/spotify_search_engine/data/half2.csv"
    ...
    footer_container.image("spotify_search/spotify_search_engine-main/spotify_search_engine-main/spotify_search_engine/images/download (2).jpg", use_column_width=True)
